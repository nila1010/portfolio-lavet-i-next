    ...
    <>
      <section id="about" className="block md:flex gap-10">
        <div className="imgabout opacity-0">
          <Image priority={true} src={"/nicolai.webp"} width={478} height={636} alt="Profilbillede af Nicolai" style={{ float: "left", objectFit: "contain", alignSelf: "start", maxWidth: "40vw", marginInlineEnd: "4cqi" }} />
        </div>
        <article className="abouttext translate-x-[200%] self-center min-w-80 max-w-prose">
          <h2 className="text-5xl font-bold lg:text-7xl after:content-['_mig'] after:text-customorange">Om</h2>
          <div className="text-base md:text-xl mt-6 font-thin">
            <p className="mb-4 min-w-prose">Jeg er en passioneret Frontend Developer, som brænder for at skabe brugercentreret og bæredygtige løsninger ved hjælp af mine færdigheder inden for HTML, CSS, JavaScript, Databaser, Astro og React/Next.js.</p>
